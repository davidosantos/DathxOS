...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/system: ../../DathxLib/dist/Release/GNU-Linux/libdathxlib.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/system: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	ld -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/system ${OBJECTFILES} ${LDLIBSOPTIONS} -T ./scripts/link.ld -o "./bin/system"
