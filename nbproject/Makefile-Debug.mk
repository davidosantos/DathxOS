...
${OBJECTDIR}/system/Cmos.o: system/Cmos.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/system/Cmos.o system/Cmos.cpp

${OBJECTDIR}/system/DathxMain.o: system/DathxMain.cpp 
	${MKDIR} -p ${OBJECTDIR}/system
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/system/DathxMain.o system/DathxMain.cpp
...
${OBJECTDIR}/system/Providers/Messaging.o: system/Providers/Messaging.cpp 
	${MKDIR} -p ${OBJECTDIR}/system/Providers
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/system/Providers/Messaging.o system/Providers/Messaging.cpp
...
${OBJECTDIR}/system/Tasks/Tasks.o: system/Tasks/Tasks.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/system/Tasks/Tasks.o system/Tasks/Tasks.cpp
...
${OBJECTDIR}/system/drivers/HardDriveDriver.o: system/drivers/HardDriveDriver.cpp 
	${MKDIR} -p ${OBJECTDIR}/system/drivers
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/system/drivers/HardDriveDriver.o system/drivers/HardDriveDriver.cpp

${OBJECTDIR}/system/drivers/HardwareIO.o: system/drivers/HardwareIO.cpp 
	${MKDIR} -p ${OBJECTDIR}/system/drivers
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/system/drivers/HardwareIO.o system/drivers/HardwareIO.cpp

${OBJECTDIR}/system/drivers/driverManager.o: system/drivers/driverManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/system/drivers
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/system/drivers/driverManager.o system/drivers/driverManager.cpp

${OBJECTDIR}/system/fs/FAT32.o: system/fs/FAT32.cpp 
	${MKDIR} -p ${OBJECTDIR}/system/fs
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/system/fs/FAT32.o system/fs/FAT32.cpp

${OBJECTDIR}/system/fs/File.o: system/fs/File.cpp 
	${MKDIR} -p ${OBJECTDIR}/system/fs
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/system/fs/File.o system/fs/File.cpp

${OBJECTDIR}/system/fs/MBR.o: system/fs/MBR.cpp 
	${MKDIR} -p ${OBJECTDIR}/system/fs
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/system/fs/MBR.o system/fs/MBR.cpp

${OBJECTDIR}/system/memory/Memory.o: system/memory/Memory.cpp 
	${MKDIR} -p ${OBJECTDIR}/system/memory
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/system/memory/Memory.o system/memory/Memory.cpp

${OBJECTDIR}/system/memory/Paging.o: system/memory/Paging.cpp 
	${MKDIR} -p ${OBJECTDIR}/system/memory
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/system/memory/Paging.o system/memory/Paging.cpp

${OBJECTDIR}/system/memory/pageManagment.o: system/memory/pageManagment.cpp 
	${MKDIR} -p ${OBJECTDIR}/system/memory
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/system/memory/pageManagment.o system/memory/pageManagment.cpp

${OBJECTDIR}/system/monitor/Console.o: system/monitor/Console.cpp 
	${MKDIR} -p ${OBJECTDIR}/system/monitor
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/system/monitor/Console.o system/monitor/Console.cpp

${OBJECTDIR}/system/processor.o: system/processor.cpp 
	${MKDIR} -p ${OBJECTDIR}/system
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/system/processor.o system/processor.cpp

${OBJECTDIR}/util/util.o: util/util.cpp 
	${MKDIR} -p ${OBJECTDIR}/util
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/util/util.o util/util.cpp
