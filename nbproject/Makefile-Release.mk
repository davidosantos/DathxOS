...
${OBJECTDIR}/system/Providers/InputProvider.o: system/Providers/InputProvider.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/system/Providers/InputProvider.o system/Providers/InputProvider.cpp

${OBJECTDIR}/system/Providers/Keyboard.o: system/Providers/Keyboard.cpp 
	${MKDIR} -p ${OBJECTDIR}/system/Providers
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/system/Providers/Keyboard.o system/Providers/Keyboard.cpp

${OBJECTDIR}/system/Providers/Messaging.o: system/Providers/Messaging.cpp 
	${MKDIR} -p ${OBJECTDIR}/system/Providers
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/system/Providers/Messaging.o system/Providers/Messaging.cpp
